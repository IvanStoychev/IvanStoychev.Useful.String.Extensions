...
namespace IvanStoychev.Useful.String.Extensions
{
    ...
    static class ExceptionThrower
    {
        ...
        internal static void Throw_ArgumentNullException(string parameterName)
        ...
        /// </summary>
        /// <param name="parameterName">Name of the parameter in the original calling method.</param>
        internal static void Throw_ArgumentNullMemberException(string parameterName)
        ...
        internal static void Throw_ArgumentOutOfRangeException_Amount(int amount, int lengthDiff, [CallerArgumentExpression("amount")] string parameterName = null)
        ...
        /// <param name="lengthDiff">The difference between the string length and the amount of characters requested by the user.</param>
        /// <param name="parameterName">Name of the parameter in the original method whose argument is <paramref name="amount"/>.</param>
        internal static void Throw_ArgumentOutOfRangeException_DoubleAmount(int amount, int lengthDiff, [CallerArgumentExpression("amount")] string parameterName = null)
        ...
        internal static void Throw_ArgumentOutOfRangeException_Endstring(string startString, string endString,
        ...
        internal static void Throw_ArgumentOutOfRangeException_Length(int length, string parameterName)
        ...
        internal static void Throw_ArgumentOutOfRangeException_Length(int length, int lengthDiff, [CallerArgumentExpression("length")] string parameterName = null)
        ...
        internal static void Throw_ArgumentOutOfRangeException_Substring(string substring, string parameterName)
        {
