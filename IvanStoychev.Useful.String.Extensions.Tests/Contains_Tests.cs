...
public class Contains_Tests
{
    ...
    public static IEnumerable<object[]> Data_ContainsAny_IEnumString_DefaultComparison_Pass =>
            [
                ["case encyclopædia Archæology", new string[] { "dummy", "case", "dummy", "dummy" }],
                ...
                ["case encyclopædia Archæology", new Queue<string>(["dummy", "case", "encyclopædia", "Archæology"])]
            ];

    public static IEnumerable<object[]> Data_ContainsAny_IEnumString_DefaultComparison_Fail =>
            [
                ["case encyclopædia Archæology", new string[] { "dummy", "Case", "encyclopaedia", "ARCHÆOLOGY" }],
                ...
                ["case encyclopædia Archæology", new Queue<string>(["dummy", "Case", "encyclopaedia", "ARCHÆOLOGY"])]
            ];

    public static IEnumerable<object[]> Data_ContainsAny_IEnumString_SetComparison_Pass =>
            [
                ["case encyclopædia Archæology", new string[] { "dummy", "case", "dummy" }, GlobalVariables.InvariantCulture],
                ...
                ["case encyclopædia Archæology", new Queue<string>(["case", "encyclopædia", "Archæology"]), GlobalVariables.InvariantCulture],
                ...
                ["case encyclopædia Archæology", new Queue<string>(["Case", "encyclopædiA", "ARCHÆOLOGY"]), GlobalVariables.InvariantCultureIgnoreCase],
                ...
                ["case encyclopædia Archæology", new Queue<string>(["case", "encyclopædia", "Archæology"]), GlobalVariables.Ordinal],
                ...
                ["case encyclopædia Archæology", new Queue<string>(["Case", "encyclopædiA", "ARCHÆOLOGY"]), GlobalVariables.OrdinalIgnoreCase]
            ];

    public static IEnumerable<object[]> Data_ContainsAny_IEnumString_SetComparison_Fail =>
            [
                ["case encyclopædia Archæology", new string[] { "dummy", "Case", "dummy" }, GlobalVariables.InvariantCulture],
                ["case encyclopædia Archæology", new List<string>() { "dummy", "encyclopaedia", "dummy" }, GlobalVariables.InvariantCulture],
                ["case encyclopædia Archæology", new HashSet<string>() { "dummy", "ARCHÆOLOGY", "dummy" }, GlobalVariables.InvariantCulture],
                ["case encyclopædia Archæology", new Queue<string>(["Case", "encyclopaedia", "ARCHÆOLOGY"]), GlobalVariables.InvariantCulture],
                ...
                ["case encyclopædia Archæology", new Queue<string>(["Kase", "encyclopaedia", "ARCHAEOLOGY"]), GlobalVariables.InvariantCultureIgnoreCase],

                ["case encyclopædia Archæology", new string[] { "dummy", "Case", "dummy" }, GlobalVariables.Ordinal],
                ["case encyclopædia Archæology", new List<string>() { "dummy", "encyclopaedia", "dummy" }, GlobalVariables.Ordinal],
                ["case encyclopædia Archæology", new HashSet<string>() { "dummy", "ARCHÆOLOGY", "dummy" }, GlobalVariables.Ordinal],
                ["case encyclopædia Archæology", new Queue<string>(["Case", "encyclopaedia", "ARCHÆOLOGY"]), GlobalVariables.Ordinal],
                ...
                ["case encyclopædia Archæology", new Queue<string>(["Kase", "encyclopaedia", "Archaeology"]), GlobalVariables.OrdinalIgnoreCase]
            ];

    public static IEnumerable<object[]> Data_ContainsAny_IEnumChar_DefaultComparison_Pass =>
            [
                ["char", new char[] { 'c', 'z', 'z', 'z' }],
                ["char", new List<char>() { 'z', 'h', 'z', 'z' }],
                ["char", new HashSet<char>() { 'z', 'z', 'a', 'z' }],
                ["char", new Queue<char>(['z', 'z', 'z', 'r'])]
            ];

    public static IEnumerable<object[]> Data_ContainsAny_IEnumChar_DefaultComparison_Fail =>
            [
                ["char", new char[] { 'C', 'z', 'z', 'z' }],
                ["char", new List<char>() { 'z', 'H', 'z', 'z' }],
                ["char", new HashSet<char>() { 'z', 'z', 'A', 'z' }],
    ...
    public static IEnumerable<object[]> Data_ContainsAny_IEnumChar_SetComparison_Pass =>
            [
                ["i" /* (U+0069) */, new char[] { 'i' /* (U+0069) */, 'z', 'z', 'z' }, GlobalVariables.InvariantCulture],
    ...
    // The comments denote what is the code for the character preceding them as visually they are very similar.
    public static IEnumerable<object[]> Data_ContainsAny_IEnumChar_SetComparison_Fail =>
            [
                ["i" /* (U+0069) */, new char[] { 'ı' /* (U+0131) */, 'z', 'z', 'z' }, GlobalVariables.InvariantCulture],
    ...
    public static IEnumerable<object[]> Data_ContainsAll_IEnumString_DefaultComparison_Pass =>
            [
                ["case encyclopædia Archæology", new[] { "case", "encyclopædia", "Archæology" }],
                ...
                ["case encyclopædia Archæology", new Queue<string>(["case", "encyclopædia", "Archæology"])]
            ];

    public static IEnumerable<object[]> Data_ContainsAll_IEnumString_SetComparison_Pass =>
            [
                ["case encyclopædia Archæology", new[] { "case", "encyclopædia", "Archæology" }, GlobalVariables.InvariantCulture],
    ...
    public static IEnumerable<object[]> Data_ContainsAll_IEnumChar_DefaultComparison_Pass =>
            [
                ["char", new[] { 'c', 'h', 'a', 'r' }],
    ...
    // The comments denote what is the code for the character preceding them as visually they are very similar.
    public static IEnumerable<object[]> Data_ContainsAll_IEnumChar_SetComparison_Pass =>
            [
                ["iz" /* (U+0069) */, new char[] { 'i' /* (U+0069) */, 'z', 'z', 'z' }, GlobalVariables.InvariantCulture],
