...
public class Replace_Tests
{
    ...
    public static IEnumerable<object[]> Data_Replace_IEnumString_Char_SetComparison
        =>
            [
                ["Sunset painted the sky beautifully.",     'z',    new[] { "paint", "sky ", "beaut" },                             GlobalVariables.InvariantCulture,               "Sunset zed the zzifully."],
                ...
                ["Sunset painted the sky beautifully.",     'z',    new Queue<string>(["paint", "sky ", "beaut"]),                  GlobalVariables.InvariantCulture,               "Sunset zed the zzifully."],
                ["SUNSET PAINTED THE SKY BEAUTIFULLY.",     'z',    new Queue<string>(["paint", "sky ", "beaut"]),                  GlobalVariables.InvariantCultureIgnoreCase,     "SUNSET zED THE zzIFULLY."],
                ["Sunset painted the sky beautifully.",     'z',    new Queue<string>(["paint", "sky ", "beaut"]),                  GlobalVariables.Ordinal,                        "Sunset zed the zzifully."],
                ["SUNSET PAINTED THE SKY BEAUTIFULLY.",     'z',    new Queue<string>(["paint", "sky ", "beaut"]),                  GlobalVariables.OrdinalIgnoreCase,              "SUNSET zED THE zzIFULLY."]
            ];
    ...
    public static IEnumerable<object[]> Data_Replace_IEnumString_String_SetComparison
        =>
            [
                ["Sunset painted the sky beautifully.",     "new",      new[] { "paint", "sky ", "beaut" },                             GlobalVariables.InvariantCulture,               "Sunset newed the newnewifully."],
                ...
                ["Sunset painted the sky beautifully.",     "new",      new Queue<string>(["paint", "sky ", "beaut"]),                  GlobalVariables.InvariantCulture,               "Sunset newed the newnewifully."],
                ["SUNSET PAINTED THE SKY BEAUTIFULLY.",     "new",      new Queue<string>(["paint", "sky ", "beaut"]),                  GlobalVariables.InvariantCultureIgnoreCase,     "SUNSET newED THE newnewIFULLY."],
                ["Sunset painted the sky beautifully.",     "new",      new Queue<string>(["paint", "sky ", "beaut"]),                  GlobalVariables.Ordinal,                        "Sunset newed the newnewifully."],
                ["SUNSET PAINTED THE SKY BEAUTIFULLY.",     "new",      new Queue<string>(["paint", "sky ", "beaut"]),                  GlobalVariables.OrdinalIgnoreCase,              "SUNSET newED THE newnewIFULLY."]
            ];
    ...
    public static IEnumerable<object[]> Data_Replace_IEnumChar_String_SetComparison
        =>
            [
                ["a b 3 C r $ 9 P x # 7 o L",   "new",      new[] { 'b', '$', 'P', '#' },                                   GlobalVariables.InvariantCulture,               "a new 3 C r new 9 new x new 7 o L"],
                ...
                ["a b 3 C r $ 9 P x # 7 o L",   "new",      new Queue<char>(['b', '$', 'P', '#']),                          GlobalVariables.InvariantCulture,               "a new 3 C r new 9 new x new 7 o L"],
                ["A B 3 C R $ 9 P X # 7 O L",   "new",      new Queue<char>(['b', '$', 'P', '#']),                          GlobalVariables.InvariantCultureIgnoreCase,     "A new 3 C R new 9 new X new 7 O L"],
                ["a b 3 C r $ 9 P x # 7 o L",   "new",      new Queue<char>(['b', '$', 'P', '#']),                          GlobalVariables.Ordinal,                        "a new 3 C r new 9 new x new 7 o L"],
                ["A B 3 C R $ 9 P X # 7 O L",   "new",      new Queue<char>(['b', '$', 'P', '#']),                          GlobalVariables.OrdinalIgnoreCase,              "A new 3 C R new 9 new X new 7 O L"]
            ];
    ...
    public static IEnumerable<object[]> Data_Replace_IEnumKVPStringString_SetComparison
        =>
            [
                ["Sunset painted the sky beautifully.",     new Dictionary<string, string>() { { "paint", "new1" }, { "sky ", "new2" }, { "beaut", "new3" } },                                              GlobalVariables.InvariantCulture,               "Sunset new1ed the new2new3ifully."],
    ...
    public static IEnumerable<object[]> Data_Replace_IEnumKVPStringChar_SetComparison
        =>
            [
                ["Sunset painted the sky beautifully.",     new Dictionary<string, char>() { { "paint", 'x' }, { "sky ", 'y' }, { "beaut", 'z' } },                                                         GlobalVariables.InvariantCulture,               "Sunset xed the yzifully."],
    ...
    public static IEnumerable<object[]> Data_Replace_IEnumKVPCharString_SetComparison
        =>
            [
                ["a b 3 C r $ 9 P x # 7 o L",   new Dictionary<char, string>() { { 'b', "new1" }, { '$', "new2" }, { 'P', "new3" } },                                                           GlobalVariables.InvariantCulture,               "a new1 3 C r new2 9 new3 x # 7 o L"],
